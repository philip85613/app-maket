...
<html lang="en">
    <head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath }/statics/bootstrap-table/bootstrap-table.css">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="${pageContext.request.contextPath }/doAppAdd" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
                                            <div class="alert alert-danger display-hide">
                                                <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                                            <div class="alert alert-success display-hide">
                                                <button class="close" data-close="alert"></button> Your form validation is successful! </div>
                                            <input type="hidden" name="id" data-required="1" class="form-control" />
                                            <div class="form-group">
                                                <label class="control-label col-md-3">软件名称
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <input type="text" name="softwareName" data-required="1" class="form-control" value=""/> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="APKName" data-required="1" class="form-control" value=""/> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="supportROM" type="text" class="form-control" value=""/> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="interfaceLanguage" type="text" class="form-control" value=""/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="softwareSize" type="text" class="form-control" value=""/> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="downloads" type="text" class="form-control" value=""/> </div>
                                            </div>
                                            <!-- <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="appInfo" data-required="1" class="form-control" value=""/> </div>
                                            </div>
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="file" name="name" id="exampleInputFile1" data-required="1" class="form-control" /> </div>
                                            </div> -->
                                        </div>
		...
		<script src="${pageContext.request.contextPath }/statics/bootstrap-table/bootstrap-table.js"></script>
		<script src="${pageContext.request.contextPath }/statics/bootstrap-table/locale/bootstrap-table-zh-CN.js"></script>
